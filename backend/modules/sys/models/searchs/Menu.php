...
namespace backend\modules\sys\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use backend\modules\sys\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\backend\modules\sys\models\Menu]].
 *
 */
